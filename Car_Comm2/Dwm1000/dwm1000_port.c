...
void SPI1_DW1000_Configuration(void)
{
	SPI_InitTypeDef SPI_InitStructure;
	GPIO_InitTypeDef GPIO_InitStructure;
	
	// Enable SPI1 clock for DW1000
	RCC_APB2PeriphClockCmd (SPI_DW1000_RCC_CLOCK, ENABLE);
	...
	GPIO_InitStructure.GPIO_Pin = SPI_DW1000_SCK | SPI_DW1000_MOSI;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
  GPIO_Init(SPI_DW1000_GPIO, &GPIO_InitStructure);

	// SPIx MISO pin setup
	GPIO_InitStructure.GPIO_Pin = SPI_DW1000_MISO;
